...
namespace Smooth {
  ...
  export const METHOD_NEAREST = 'nearest',
  ...
  defaultConfig = {
    method: METHOD_CUBIC,
    cubicTension: CUBIC_TENSION_DEFAULT,
    clip: CLIP_CLAMP,
    scaleTo: 0,
    sincFilterSize: 2,
    sincWindow: void 0
  ...
  */
  ...
  NearestInterpolator = (function (_super) {
    ...
    function NearestInterpolator() {
      (<any>NearestInterpolator).__super__.constructor.apply(this, arguments);
    }
  ...
  LinearInterpolator = (function (_super) {
    ...
    function LinearInterpolator() {
      (<any>LinearInterpolator).__super__.constructor.apply(this, arguments);
    }
  ...
  CubicInterpolator = (function (_super) {
    ...
    function CubicInterpolator(array, config) {
      ...
      (<any>CubicInterpolator).__super__.constructor.apply(this, arguments);
    }
  ...
  SincFilterInterpolator = (function (_super) {
    ...
    function SincFilterInterpolator(array, config) {
      (<any>SincFilterInterpolator).__super__.constructor.apply(this, arguments);
